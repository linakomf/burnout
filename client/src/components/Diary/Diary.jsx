...
/** Цвета точки в календаре по индексу настроения отметки (как в форме на главной) */
...
const Diary = () => {
  ...
  const checkinHistory = useMemo(
    () => getCheckinsSortedDesc(),
    // eslint-disable-next-line react-hooks/exhaustive-deps -- bump after сохранения отметки на главной
    [checkinListTick]
  );
