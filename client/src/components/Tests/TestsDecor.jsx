    ...
    >
      <defs>
        <linearGradient id="thg1" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#d4e88a" stopOpacity="0.85" />
          <stop offset="100%" stopColor="#a3c617" stopOpacity="0.35" />
        </linearGradient>
      ...
      <circle cx="80" cy="48" r="8" fill="#a3c617" opacity="0.5" className="tests-decor-spark" />
...
export function CardBlobArt({ bucket, uid = '0' }) {
  const colors = {
    ...
    mood: { a: '#e4f4ea', b: '#4a9a6e' },
    esteem: { a: '#fce8e4', b: '#c06050' },
    other: { a: '#eef2ea', b: '#5a6b5c' },
  };
    ...
    >
      <defs>
        <linearGradient id={`insg-top-${uid}`} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#f7fbe8" />
          <stop offset="50%" stopColor="#eef6fc" />
          <stop offset="100%" stopColor="#ffffff" />
        </linearGradient>
        <radialGradient id={`insg-${uid}`} cx="50%" cy="38%" r="58%">
          <stop offset="0%" stopColor="#eef4d5" stopOpacity="0.95" />
      ...
      <g className="tests-decor-intro-float">
        ...
        <circle cx="160" cy="88" r="36" fill="#d4e88a" opacity="0.35" />
        <circle cx="52" cy="48" r="7" fill="#d4e88a" opacity="0.65" className="tests-decor-spark" />
    ...
    >
      <defs>
        <linearGradient id={`qside-a-${uid}`} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#e8f5c8" />
          <stop offset="100%" stopColor="#d4e88a" />
        </linearGradient>
        <linearGradient id={`qside-b-${uid}`} x1="0%" y1="100%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="#a3c617" stopOpacity="0.15" />
      ...
      <circle cx="20" cy="96" r="5" fill="#c4d94a" opacity="0.4" />
      <path
