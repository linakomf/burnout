...
const COVER_IMAGES = [
  ...
  'https://images.unsplash.com/photo-1527224857830-43a7bb388b77?auto=format&fit=crop&w=1200&q=85',
  'https://images.unsplash.com/photo-1513364776144-60967b0f800f?auto=format&fit=crop&w=1200&q=85',
  'https://images.unsplash.com/photo-1507676184212-d03b07a089fb?auto=format&fit=crop&w=1200&q=85',
  'https://images.unsplash.com/photo-1520523839897-bd9eacf1a8f2?auto=format&fit=crop&w=1200&q=85',
...
const EVENTS = [
  ...
  // —— Один (Алматы, июнь 2026) ——
  {
    ...
    kind: 'solo',
    filter_cat: 'lectures',
    category_label: 'Лекция',
    price_key: 'от 2000 ₸',
    tf_mood: 'calm',
    when: 'Июнь 2026',
    ticket_url: 'https://sxodim.com/almaty',
    venue_line: 'Art Society Almaty',
    venue_pin_text: 'Art Society Almaty',
    organizer_name: 'Art Society Almaty',
    teaser: 'Лекция о современном искусстве и визуальных трендах в уютном пространстве Алматы.',
    about_text:
      'Открытая лекция о современном искусстве, культуре и визуальных трендах в уютном пространстве Алматы. Формат подходит для спокойного вечера и новых знакомств.',
    duration_label: '1.5 ч',
    age_label: '16+',
    genre_label: 'Лекция / искусство',
    suit_tags: [
      'Интровертам',
      'Тем, кто любит спокойные события',
      'Любителям искусства',
      'Тем, кто хочет провести вечер одному',
    ],
    important_notes: [
  ...
  },
  {
    ...
    kind: 'solo',
    filter_cat: 'other',
    category_label: 'Стендап',
    price_key: 'от 5000 ₸',
    tf_mood: 'energy',
    when: 'Июнь 2026',
    ticket_url: 'https://ticketon.kz/almaty/stand-up',
    venue_line: 'Stand Up Camp, Алматы',
    venue_pin_text: 'Stand Up Camp',
    organizer_name: 'Stand Up Camp',
    teaser: 'Вечер стендапа с местными комиками — легко и без напряжения, можно одному.',
    about_text:
      'Вечер стендапа с местными комиками и атмосферой живого общения. Отличный вариант выбраться одному и провести вечер легко и без напряжения.',
    duration_label: '2 ч',
    age_label: '18+',
    genre_label: 'Стендап / юмор',
    suit_tags: [
      'Тем, кто хочет расслабиться',
      'Любителям юмора',
      'Тем, кто хочет выйти в город одному',
    ],
    important_notes: [
  ...
  },
  {
    ...
    kind: 'solo',
    filter_cat: 'workshops',
    category_label: 'Живопись',
    price_key: 'от 8000 ₸',
    tf_mood: 'calm',
    when: 'Июнь 2026',
    ticket_url: 'https://ticketon.kz/almaty',
    venue_line: 'Творческая академия «Яблоко», Алматы',
    venue_pin_text: 'Академия «Яблоко»',
    organizer_name: 'Творческая академия «Яблоко»',
    teaser: 'Творческий вечер с рисованием акрилом или маслом — подходит даже новичкам.',
    about_text:
      'Творческий вечер с рисованием акрилом или маслом под руководством художника. Подходит даже для новичков.',
    duration_label: '2 ч',
    age_label: '14+',
    genre_label: 'Мастер-класс / творчество',
    suit_tags: ['Любителям творчества', 'Тем, кто хочет снять стресс', 'Новичкам без опыта'],
    important_notes: ['Все материалы входят в стоимость', 'Картину можно забрать с собой'],
  },
  {
    title: 'Балет «Лебединое озеро»',
    kind: 'solo',
    filter_cat: 'theater',
    category_label: 'Балет',
    price_key: 'от 5000 ₸',
    tf_mood: 'calm',
    when: 'Июнь 2026',
    ticket_url: 'https://gorodzovet.ru/almaty/2026/june/',
    venue_line: 'Театр оперы и балета им. Абая, пр. Кабанбай батыра 110',
    venue_pin_text: 'ГАТОБ им. Абая',
    organizer_name: 'ГАТОБ им. Абая',
    teaser: 'Классическая балетная постановка для атмосферного культурного вечера.',
    about_text: 'Классическая балетная постановка для атмосферного культурного вечера в Алматы.',
    duration_label: '2.5 ч',
    age_label: '12+',
    genre_label: 'Балет / классика',
    suit_tags: [
      'Любителям классики',
      'Тем, кто хочет красивый спокойный вечер',
      'Туристам и студентам',
    ],
    important_notes: [
      'Желателен классический стиль одежды',
      'Лучше приходить за 20–30 минут',
    ],
  },
  {
    title: 'Органная музыка в филармонии',
    kind: 'solo',
    filter_cat: 'concerts',
    category_label: 'Классика',
    price_key: 'от 3000 ₸',
    tf_mood: 'calm',
    when: 'Июнь 2026',
    ticket_url: 'https://ticketon.kz/almaty/concerts',
    venue_line: 'Филармония им. Жамбыла, ул. Калдаякова 39',
    venue_pin_text: 'Казахская гос. филармония',
    organizer_name: 'Филармония им. Жамбыла',
    teaser: 'Концерт органной и симфонической музыки в атмосферной площадке Алматы.',
    about_text:
      'Концерт органной и симфонической музыки в одной из самых атмосферных площадок Алматы.',
    duration_label: '1.5 ч',
    age_label: '10+',
    genre_label: 'Классическая музыка',
    suit_tags: [
      'Любителям музыки',
      'Тем, кто хочет расслабиться',
      'Для одиночного культурного отдыха',
    ],
    important_notes: [
      'Во время концерта нельзя пользоваться телефоном',
      'Есть электронные билеты',
    ],
  },
  {
    title: 'Спектакль в ARTиШОК',
    kind: 'solo',
    filter_cat: 'theater',
    category_label: 'Спектакль',
    price_key: 'от 4000 ₸',
    tf_mood: 'calm',
    when: 'Июнь 2026',
    ticket_url: 'https://gorodzovet.ru/almaty/2026/june/',
    venue_line: 'ARTiШОК, Үлкен Сахна, ул. Гоголя',
    venue_pin_text: 'ARTiШОК',
    organizer_name: 'ARTiШОК',
    teaser: 'Современный экспериментальный спектакль с необычной постановкой.',
    about_text:
      'Современный экспериментальный спектакль с необычной постановкой и визуальной подачей.',
    duration_label: '2 ч',
    age_label: '16+',
    genre_label: 'Спектакль / современный театр',
    suit_tags: [
      'Любителям театра',
      'Тем, кто ищет необычный формат',
      'Для спокойного вечера одному',
    ],
    important_notes: ['Рекомендуем прийти за 15–20 минут', 'Билеты лучше брать заранее'],
  },
];
