...
(5, 'Тест на рабочую перегрузку', '9 вопросов по шкале от «Никогда» до «Всегда»', 1, 'likert_sum'),
(6, 'GAD-7: скрининг тревожности', 'Семь вопросов за последние 2 недели. Логика GAD-7; не заменяет консультацию врача.', 1, 'gad7'),
(7, 'Ежедневный чек-ин (9 вопросов)', 'Те же варианты ответа, что в основном опросе — для сопоставимой динамики в аналитике.', 1, 'daily5');
...
INSERT INTO questions (test_id, question_text, options, order_num) VALUES
(7, 'Я чувствую усталость (физическую и эмоциональную)', '["Никогда","Редко","Иногда","Часто","Всегда"]', 1),
(7, 'Мне трудно сосредоточиться на задачах', '["Никогда","Редко","Иногда","Часто","Всегда"]', 2),
(7, 'Я испытываю тревогу или напряжение', '["Никогда","Редко","Иногда","Часто","Всегда"]', 3),
(7, 'Я откладываю дела или избегаю их', '["Никогда","Редко","Иногда","Часто","Всегда"]', 4),
(7, 'День ощущается тяжёлым или неприятным', '["Никогда","Редко","Иногда","Часто","Всегда"]', 5),
(7, 'Мне трудно расслабиться', '["Никогда","Редко","Иногда","Часто","Всегда"]', 6),
(7, 'Я раздражителен или легко выхожу из себя', '["Никогда","Редко","Иногда","Часто","Всегда"]', 7),
(7, 'Мне не хватает сил на то, что раньше давалось легче', '["Никогда","Редко","Иногда","Часто","Всегда"]', 8),
(7, 'К вечеру я чувствую опустошённость', '["Никогда","Редко","Иногда","Часто","Всегда"]', 9);
